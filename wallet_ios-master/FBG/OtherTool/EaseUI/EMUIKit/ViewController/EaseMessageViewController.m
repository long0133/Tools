...
- (void)didStartRecordingVoiceAction:(UIView *)recordView
{
    ...
    [self _canRecordCompletion:^(EMRecordResponse recordResponse) {
        switch (recordResponse) {
            ...
            case EMCanNotRecord:
            {
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:DBHGetStringWithKeyFromTable(@"prompt", @"Prompt") message:DBHGetStringWithKeyFromTable(@"record.failToPermission", @"No recording permission") delegate:nil cancelButtonTitle:DBHGetStringWithKeyFromTable(@"ok", @"OK") otherButtonTitles:nil, nil];
                [alertView show];
            }
                break;
            default:
