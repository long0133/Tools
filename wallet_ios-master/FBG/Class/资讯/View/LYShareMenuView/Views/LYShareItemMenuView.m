...
- (void)setup{
    ...
    self.shareItemButton.frame = CGRectMake(0, 30, kShareItemWidth - padding, kShareItemWidth - padding);
    self.shareItemDesLabel.frame = CGRectMake(0, CGRectGetMaxY(self.shareItemButton.frame) + padding, kShareItemWidth, 25);
...
- (UIButton *)shareItemButton{
    if (!_shareItemButton) {
        ...
        _shareItemButton.layer.cornerRadius = 5;
        _shareItemButton.layer.masksToBounds = YES;
        [_shareItemButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 5, 0, 5)];
        _shareItemButton.imageView.contentMode = UIViewContentModeScaleAspectFit;
    }
...
- (UILabel *)shareItemDesLabel{
    if (!_shareItemDesLabel) {
        ...
        _shareItemDesLabel.font = [UIFont systemFontOfSize:12];
