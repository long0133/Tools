...
static const CGFloat        kSeparatorDefaultHeight = 0.0;
...
- (void)segmentDidSelectAtIndex:(NSUInteger)newIndex didDeselectAtIndex:(NSUInteger)oldIndex {
    ...
    {
//        if (newIndex + 1 > self.numberOfSegments)
//        {
//            UILabel *selectedLabel = (UILabel *)(_items[self.numberOfSegments].view);
//            selectedLabel.attributedText = [[NSAttributedString alloc] initWithString:_contents[self.numberOfSegments] attributes:_attributesSelected];
//            return;
//        }
