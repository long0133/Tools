...
- (void)commonInit {
    ...
    [self.prevButton setImage:[UIImage imageNamed:@"candyzhuye_zuofanfan"] forState:UIControlStateNormal];
    ...
    [self.nextButton setImage:[UIImage imageNamed:@"candyzhuye_youfan"] forState:UIControlStateNormal];
